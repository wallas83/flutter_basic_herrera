...
class BasicoPage extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Center(
        child: Row(
          ...
          children: <Widget>[
            _nombres(Icon(Icons.call,color: Colors.blueAccent), "call"),
            _nombres(Icon(Icons.settings_backup_restore,color: Colors.blueAccent), "Route"),
            _nombres(Icon(Icons.share,color: Colors.blueAccent,), "Share")
          ],
        ),
      ),
    );
  ...
  Widget _nombres(Icon icono, String texto) {
    return Column(
      children: <Widget>[icono, Text(texto,style: TextStyle(color: Colors.blueAccent),)],
    );
  }
}
